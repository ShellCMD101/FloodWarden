# FloodWarden Mitigation System: Advanced Network Defense

> **A Comprehensive Real-Time DoS/DDoS Attack Detection & Mitigation Platform**
...
- **-- Configurable Thresholds** - Adaptive rate limiting and detection parameters
...
## -- Tech Stack & Implemented Libraries
...
- **Two Windows PCs** with network connectivity
...
- **-- DoS/DDoS Mitigation Strategies** - Defense mechanism design
